<div class="recent-game container-fluid">
  ...
  <div class="row recent-game-result">
    ...
    <div class="col-md-1 ${"yellow-stripe" if game.redScore == 10 else ""}" style="padding:0px;">
    ...
    <div class="col-md-1 ${"yellow-stripe" if game.blueScore == 10 else ""}" style="padding:0px;">
        <div style="display:table;margin-left: auto;margin-right: auto;">
